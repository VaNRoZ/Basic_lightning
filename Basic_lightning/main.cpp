...
int main()
{
	//glfw: initialise and configuration
	glfwInit();
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "OpenGL IVAN",
		NULL, NULL);
	if (window == NULL)
	{
	...
	//compiling usshader programm
	Shader lightingShader("../2.2.basic_lighting.vs", "../2.2.basic_lighting.fs");
	Shader lampShader("../2.2.lamp.vs", "../2.2.lamp.fs");

	//Specifying vertuces (and buffer) and Setting vertex attributes
	float vertices[] = {
	...
	//1. configuring the VAO(and VBO) of the cube
	...
	//Note that we are updating the step of the lamp position attribute to refiect the updated
	//buffer data
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
	...
	{
		//the logic part of working with time for each frame
